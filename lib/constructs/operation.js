...
Operation.prototype.generate = function () {
  ...
  if (this.idl.name === null) return { prefix: "", body: "" };
  ...
  const parameterConversions = Parameters.generateConversions(overloads, this.obj.opts.customTypes);
  prefix += parameterConversions.prefix;
