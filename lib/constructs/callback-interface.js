  ...
  generateConversion() {
    ...
    this.str += `
      exports.convert = function convert(value, { context = "The provided value" } = {}) {
        ...
        function converted(${argsLength > 0 ? "...args" : ""}) {
          let thisArg = this;
          let O = value;
          let X = O;
    `;
    ...
    // This is necessary to avoid exposing `converted` to user code:
    this.str += `
        converted[utils.wrapperSymbol] = value;
        converted.objectReference = value;
