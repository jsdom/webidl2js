...
Attribute.prototype.generate = function () {
  ...
  let getterBody = `${propSource}${targetObj}.getOwnProperyDescriptor("${this.idl.name}").get.call(this);`;
  let setterBody = `Impl.interface${targetObj}.getOwnProperyDescriptor("${this.idl.name}").set.call(this, V);`;
  if (shouldReflect) {
