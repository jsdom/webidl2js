    ...
    this.str += `
        ...
        if (utils.hasOwn(Impl.implementation.prototype, utils.inspectCustomSymbol)) {
          Object.defineProperty(${this.name}.prototype, utils.inspectCustomSymbol, {
            value: {
              [utils.inspectCustomSymbol](depth, ctx) {
                if (!this || !exports.is(this)) {
                  throw new TypeError("Illegal invocation");
                }
                if (arguments.length < 2) {
                  throw new TypeError("Failed to execute '[nodejs.util.inspect.custom]' on '${
  this.name}': 2 arguments required, but only " + arguments.length + " present.");
                }
                const args = [];
                {
                  let curArg = arguments[0];
                  curArg = conversions["unrestricted double"](curArg, {
                    context: "Failed to execute '[nodejs.util.inspect.custom]' on '${this.name}': parameter 1",
                  });
                  args.push(curArg);
                }
                {
                  ...
                  curArg = conversions["object"](curArg, {
                    context: "Failed to execute '[nodejs.util.inspect.custom]' on '${this.name}': parameter 2",
                  });
                  conversions["Function"](curArg.stylize, {
                    context: "Failed to execute '[nodejs.util.inspect.custom]' on '${
  this.name}': parameter 2 has member stylize that",
                  });
                  args.push(curArg);
                }
                return this[impl][utils.inspectCustomSymbol](...args);
              },
            }[utils.inspectCustomSymbol],
            writable: true,
            enumerable: false,
            configurable: true
          });
